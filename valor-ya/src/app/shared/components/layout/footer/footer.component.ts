...
export class Footer {
  ...
  redes_sociales = [
    ...
    },
    {
      ...
      svg: this.sanitizer.bypassSecurityTrustHtml(
        `<svg fill="none" height="24" viewBox="0 0 24 24" width="24"><rect fill="#3366CC" height="24" rx="2" width="24"></rect><path d="M15.441 12.8437L15.8517 10.1399H13.2838V8.38533C13.2838 7.64562 13.6426 6.92459 14.7926 6.92459H15.96V4.62261C15.96 4.62261 14.9007 4.43994 13.8878 4.43994C11.773 4.43994 10.3907 5.73494 10.3907 8.07923V10.1399H8.04004V12.8437H10.3907V19.3799H13.2838V12.8437H15.441Z" fill="white"></path></svg>`
      ),
    },
    {
      nombre: '@CatastroBogota',
      ...
      svg: this.sanitizer.bypassSecurityTrustHtml(
        `<svg fill="none" height="25" viewBox="0 0 25 25" width="25"><rect fill="#3366CC" height="25" rx="2" width="25"></rect><path d="M5.03906 6L11.2162 14.2613L5 20.9752H6.39904L11.8416 15.0961L16.2402 20.9755H21L14.4749 12.251L20.2611 6H18.862L13.8499 11.4136L9.7998 6H5.03906ZM7.09659 7.03073H9.28378L18.9415 19.9444H16.755L7.09659 7.03073Z" fill="white"></path></svg>`
      ),
    },
    {
      nombre: '@CatastroBogota',
